...
$name = $DOB = $GENDER = $Blood_G =$CR1=$CR= "";

$Present_Add_Error=$Permanent_Add_Error=$Mail_Error=$Mobile_No_Error=$Telephone_No_Error ="";
$Present_Add = $Permanent_Add = $Mail = $CRErr = $Mobile_No = $Telephone_No = "";
...
//---------------------------contact---------------------------
  ...
  if(empty($_POST["CR"])) 
  {
    $CRErr = "Car Registration can not be Empty";
  }
  else
  {
    $CR = $_POST["CR"];
...
$sql0 = "SELECT AD_ID FROM ambulance_driver ORDER BY AD_ID DESC LIMIT 1";
...
if(isset(($_POST['create'])))
{
  ...
  if(($name != "")and ($nameErr == "") and($dayErr == "")and($monthErr == "")and($yearErr == "")and($genderErr == "")and($B_GErr == "")and($Present_Add_Error == "")and($Permanent_Add_Error == "")and($Mail_Error == "")and($Mobile_No_Error == "")and($User_name_Error == "")and($Pass_Error == "")and($Confirm_Pass_Error == "")and($CRErr==""))
  {
    ...
    //----------------------------Data Insert (Driver)------------------------
    $sql3 = "INSERT INTO ambulance_driver(AD_ID, Vehicle_Reg, A_ID)
    VALUES ('$ID', '$CR', '$id')";
  ...
  <div align="center">
    ...
    <div align="center" class="ex1">
          ...
          <form method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>"> 
            ...
            <fieldset align="left" class = "width750_height780_Dvr_Rep" style="height: 810px;">
              
              <legend align="center" class="color_blue"><b>DRIVER REGISTRATION</b></legend>
                <fieldset>
                ...
                <fieldset>
                    ...
                    <div class="pad5px">
                    <label class="label">Car Registration</label>
                    :<input type="text" name="CR" value="<?php echo $CR1; ?>" size="50" class="width290">
                    <label class="error">*</label>
                    </div>
                    <div class="pad_left135">
