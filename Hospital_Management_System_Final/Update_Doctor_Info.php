...
if (isset($_SESSION["id"])) 
{
  ...
  $sql2 = "SELECT * FROM Doctor WHERE D_ID='".$id."'";
...
$Present_Add_Error=$Permanent_Add_Error=$Mail_Error=$Mobile_No_Error=$Telephone_No_Error =$Linkerr="";
...
//---------------------------contact---------------------------
  ...
  {
    $Linkerr="Video Link Can Not be Empty";
  }
  else
  {
    $Link1=$_POST["Video"];
    $xyz=strcmp($Link1,"None");
    if($xyz==0)
    {
      $Linkerr="Video Link Can not be None";
    }
    else
    {
      $Link = $_POST["Video"];
              ...
              <legend align="center" class="color_blue"><b>UPDATE INFORMATION</b></legend>
                ...
                <fieldset>
                    ...
                    <div class="pad5px">
                      ...
                      :<input type="text" name="Video" value="<?php echo $Link; ?>" size="50" class="width290">
...
if(isset(($_POST['Update'])))
{
  if(($name != "")and ($nameErr == "") and($dayErr == "")and($monthErr == "")and($yearErr == "")and($genderErr == "")and($B_GErr == "")and($Present_Add_Error == "")and($Permanent_Add_Error == "")and($Mail_Error == "")and($Linkerr == ""))
  {
    ...
    $sql2 = "UPDATE Doctor SET Video_Link='".$Link."'  WHERE D_ID='".$id."'";
